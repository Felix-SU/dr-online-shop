    ...
    <nav>
	    <ul class="nav-wrap">
		    <li  id="main" class="menu-item"><a href="../../">Main</a></li>
			  <li id="about" class="menu-item"><a href="">About</a></li>
			  <li id="faq" class="menu-item"><a href="../faq">F.A.Q</a></li>
...
<div id ="bodyBlock">
  <div class="catalogNav"></div>
  <div id="body-products">
    <div class="products">About</div>
    <div class="aboutBox">
      <div class="aboutText">About Digital Resources</div>
      <div class="aboutTextcap">
        Out Mission is sells <s>loot boxes</s> arts,sprites,textures,and bla bla bla
      </div>
      <div class="advantages">
        Our Advantages
      </div>
      <div class="advantageFlex">
        <div class="advantageElBox">
          <div class="advantageEleText">
            Support 24/7
          </div>
          <div id="img1" class="advantageEleTextImg"></div>
          <div class="advantageEleccc">
            Help you anytime and anywhere....
          </div>
        </div>
      <div class="advantageElBox">
        <div class="advantageEleText">
          ...
          <div id="img2" class="advantageEleTextImg">
          </div>
          <div class="advantageEleccc">
            Yeah we have <br>half-life 3
          </div>
        </div>
        <div class="advantageElBox">
          <div class="advantageEleText">
          ...
          <div id="img3" class="advantageEleTextImg">
          </div>
          <div class="advantageEleccc">
            Yeap you can dance with us :3 
          </div>
        </div>
        <div class="advantageElBox">
          <div class="advantageEleText">
          ...
          <div id="img4" class="advantageEleTextImg">
          </div>
          <div class="advantageEleccc">
            We have refand<br>Maybe....
          </div>
        </div>
      </div>
    </div>
